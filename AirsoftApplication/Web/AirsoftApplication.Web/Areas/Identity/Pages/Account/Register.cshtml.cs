namespace AirsoftApplication.Web.Areas.Identity.Pages.Account
{
    using System;
    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            {
                var user = new ApplicationUser { PlayerName = this.Input.PlayerName, UserName = this.Input.Email, Email = this.Input.Email };
